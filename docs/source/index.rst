...
RadSSH is a Python package for Python 2.6 & 2.7. It builds upon the Paramiko package, and PyCrypto, and provides a simple, yet powerful and extensible user "shell" environment, along with some other minor utilities, and a higher level core API for Python programmers.
